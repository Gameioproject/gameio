...
class DownloadGameUseCaseTest {
    ...
    fun setup() {
        ...
        useCase = DownloadGameUseCase(gameDao, gameDiscDao, romMRepository, downloadManager, emulatorConfigDao, downloadQueueDao, gameRepository, mockk(relaxed = true), mockk(relaxed = true))
    }
